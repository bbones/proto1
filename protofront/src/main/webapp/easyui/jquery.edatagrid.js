/**
 * edatagrid - jQuery EasyUI Licensed under the GPL:
 * http://www.gnu.org/licenses/gpl.txt Copyright 2011-2015 www.jeasyui.com
  ...
  function buildGrid(target) {
    ...
    $(target).datagrid($.extend({}, opts, {
      ...
      onClickCell: function(index, field, value) {
        ...
        // focusEditor(target, field);
        // }
        if (opts.editing && opts.editIndex >= 0 && opts.editIndex != index) {
          var dg = $(this);
      ...
      return jq.each(function() {
        ...
        if (editIndex != index) {
          if (dg.datagrid('validateRow', editIndex)) {
            ...
            if (!dg.edatagrid('isEditing', index)) { return; }
