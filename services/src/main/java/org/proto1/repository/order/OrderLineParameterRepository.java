...
public interface OrderLineParameterRepository extends CrudRepository<OrderLineParameter, Long> {
	...
	@Query("select new Map(olp.id as olpId, olp.value as olpValue, p.id as paramId, olp.derivative as derivative, pn.name as paramName, uom.id as uomId, uomn.shortName as uomName) "
